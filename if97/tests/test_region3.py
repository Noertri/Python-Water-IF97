...
class TestRegion3(unittest.TestCase):
    ...
    def test_properties1(self):
        ...
        self.assertAlmostEqual(region3(rho=500, t=650, desc="cv"), cv_des, delta=1e-8)
    ...
    def test_properties2(self):
        ...
        self.assertAlmostEqual(region3(rho=200, t=650, desc="cv"), cv_des, delta=1e-8)
    ...
    def test_properties3(self):
        ...
        self.assertAlmostEqual(region3(rho=500, t=750, desc="cv"), cv_des, delta=1e-8)
