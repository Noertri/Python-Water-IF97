## About
IF97 is a python package used to calculate ordinary/pure water properties based on IAPWs-IF97 formulation. Using this package we can calculate water properties faster and efficient than using steam tables. This package has been verified with values from journals/books in [references](#References). In folder GUI, there is simple calculator as an example of implementation of this package as backend/engine/library.
...
Note: All units of inputs and outputs are in SI unit, for further details see documentation in each modules.
